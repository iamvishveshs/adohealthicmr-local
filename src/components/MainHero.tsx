    ...
    <div className="relative w-full px-4 sm:px-6 py-10 md:py-16 overflow-hidden bg-blue-900 border-b-2 border-yellow-500">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        <div className="mb-4 flex justify-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 backdrop-blur-md border border-white/10 rounded-full transition-all">
        ...
        {/* Scaled Down Heading */}
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4 leading-tight tracking-tight text-white">
          Empowering <br className="sm:hidden" />
          <span className="text-yellow-400 px-2">Punjab&apos;s Youth</span>
        </h1>

        {/* Refined Description */}
        <p className="text-sm sm:text-base md:text-lg text-blue-100/80 font-medium max-w-2xl mx-auto leading-relaxed italic mb-4">
